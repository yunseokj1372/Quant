...
class SLMA_Dual_Momentum():
    def __init__(self, prices, lookback_period, SMA, LMA, holding_period, n_selection, cost=0.001,signal_method = 'dm', weightings='emv', long_only=False, show_analytics=True):   
